    ...
    def _sample_restaurants(self) -> list[Place]:
        ...
        return [
            ...
            Place(
                ...
                rating=4.8,
                rating_source="mock",
                price_per_person_krw=45_000,
                representative_menu="안심 스테이크",
                source=self.source_name,
            ),
            Place(
                id="mock-r4",
            ...
            Place(
                ...
                place_type=PlaceType.RESTAURANT,
                category=PlaceCategory.BUNSIK,
                address="서울 송파구 올림픽로35가길 8",
                lat=37.5158,
                lng=127.1025,
                rating=4.4,
                rating_source="mock",
                price_per_person_krw=7_500,
                representative_menu="국물떡볶이 · 김밥",
                source=self.source_name,
            ),
            Place(
                id="mock-r6",
                name="올림픽로 일식당",
                place_type=PlaceType.RESTAURANT,
                category=PlaceCategory.JAPANESE,
                address="서울 송파구 올림픽로 250",
                lat=37.5135,
                lng=127.1005,
                rating=4.5,
                rating_source="mock",
                price_per_person_krw=14_000,
                representative_menu="모듬 초밥",
                source=self.source_name,
            ),
            Place(
                id="mock-r7",
                ...
                place_type=PlaceType.RESTAURANT,
                category=PlaceCategory.WESTERN,
                address="서울 송파구 잠실동 123",
                lat=37.5148,
                lng=127.1015,
                rating=4.2,
                rating_source="mock",
                price_per_person_krw=13_000,
                representative_menu="크림 파스타",
                source=self.source_name,
            ),
        ]
    ...
    def _sample_cafes(self) -> list[Place]:
        ...
        return [
            Place(
                ...
                rating=4.5,
                rating_source="mock",
                representative_menu="아메리카노 · 크루아상",
            ...
            Place(
                ...
                address="서울 송파구 신천동 45",
                lat=37.5152,
                lng=127.1030,
                rating=4.6,
                rating_source="mock",
                price_per_person_krw=9_500,
                representative_menu="마카롱 · 티라미수",
                source=self.source_name,
            ),
        ]
