"""가장 가까운 5개 상가 심층 보충 수집 후 places.json에 병합."""
...
def supplement_near_commercial(
    *,
    ...
    for place_type in (PlaceType.RESTAURANT, PlaceType.CAFE):
        for query, lat, lng in deep_commercial_searches(place_type):
    ...
    if not added:
        print("No new near-commercial places to add.")
        return 0
